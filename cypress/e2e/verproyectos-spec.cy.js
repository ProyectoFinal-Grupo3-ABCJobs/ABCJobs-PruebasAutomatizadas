...
describe('template spec', () => {
  it('passes', () => {
    ...
    cy.xpath('/html/body/app-root/div/app-ver-proyectos/div/h2').invoke('text').then((text) => {
      // Verificar que el texto contiene el nombre de la empresa esperado
      const TituloMenu = 'Listado de proyectos';
      expect(text.toLowerCase()).to.include(TituloMenu.toLowerCase());
    });
    cy.wait(1000)
